...
public class EnemyApproachSpread : MonoBehaviour
{
        ...
        out Vector2 radial, out Vector2 tangent)
    {
        ...
        if (hasGroup && distance > engagementDistance && distance < engagementDistance + arrivalDistance)
        {
            arrival01 = 1f - Mathf.Clamp01((distance - engagementDistance) / arrivalDistance);
